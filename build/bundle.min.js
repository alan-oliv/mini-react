...
var HOST_ROOT$1 = 'root'; // Effect tags
...
function resetNextUnitOfWork() {
  ...
  var root = update.from == HOST_ROOT$1 ? update.dom._rootContainerFiber : getRoot(update.instance.__fiber);
  nextUnitOfWork = {
    tag: HOST_ROOT$1,
...
function commitWork(fiber) {
  ...
  if (fiber.effectTag == PLACEMENT && fiber.tag == HOST_COMPONENT) {
    ...
    MiniReactDOM.updateDomProperties(fiber.stateNode, fiber.alternate.props, fiber.props);
