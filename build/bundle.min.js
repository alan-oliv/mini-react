...
var setNextMessage = function setNextMessage() {
  ...
  var root = from == HOST_ROOT ? dom._rootContainerFiber : findRoot(instance.__fiber);
  _nextMessage = {
    tag: HOST_ROOT,
...
var consumeMessage = function consumeMessage(wipFiber) {
  if (wipFiber.tag == CLASS_COMPONENT) {
    ...
    var _newChildElements = wipFiber.props.children;
    reconcileChildrenArray(wipFiber, _newChildElements);
  }
...
var reconcileChildrenArray = function reconcileChildrenArray(wipFiber, newChildElements) {
...
var completeWork = function completeWork(fiber) {
...
var commitWork = function commitWork(fiber) {
  ...
  if (fiber.effectTag == PLACEMENT && fiber.tag == HOST_COMPONENT) {
    ...
    _renderer.updateDomProperties(fiber.stateNode, fiber.alternate.props, fiber.props);
  } else if (fiber.effectTag == DELETION) {
    commitDeletion(fiber, domParent);
  }
};

var commitDeletion = function commitDeletion(fiber, domParent) {
  var node = fiber;
...
var MiniReactDOM = {
  ...
  createDomElement: function createDomElement(fiber) {
